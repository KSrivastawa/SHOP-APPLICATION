...
public class ShopController {
    ...
    public ResponseEntity<List<Shops>> getAllShopDetailsHandler() throws ShopException{
        ...
        for(Shops shop : shops){
           ...
           String url2 = "http://PRODUCT-SERVICE/products/getProductByShopId/"+shop.getShopId();
    ...
    @GetMapping("/getByGst/{shopGstNumber}")
    public ResponseEntity<Shops> getShopDetailsByGstHandler(@PathVariable String shopGstNumber) throws ShopException{
